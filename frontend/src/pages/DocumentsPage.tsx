...
export default function DocumentsPage() {
  ...
  return <div className="workspace-page">
    <header className="page-header"><div><h1>งานเอกสาร</h1><p>เลือกแบบฟอร์ม หรือเริ่มจากคำบรรยายงานที่ต้องการ</p></div><Link className="button" to="/documents/new/offsite-competition-pack"><FilePlus2 aria-hidden="true" />สร้างเอกสาร</Link></header>
